...
i=1  ; arYtic[i]=2; arCores[i]=1; arYhi[i]= legend_inside ? 12.5 : 9.5;  
i=i+1; arYtic[i]=5; arCores[i]=8; arYhi[i]=  27;                       
...
do for [k=1:3] {
  ...
  plot \
    ...
    f u 0:(fix(column(higher),column(c1))):(lb(column(c0+0),column(c0+1))) \
        not w labels offset 0,.7 rotate by 0 textcolor 'grey40' rotate by -35
