...
set output "nginx3_tls_small.eps"

#-------------------------------------------------------------------------------
# dimensions
#-------------------------------------------------------------------------------
xsiz = .22+.0172;  # x size of each subfi=g
ysiz = .39;  # y size of each subfig
xoff = .03;  # push all subfigs to right by xoff to make room for joint ylabel
...
#-------------------------------------------------------------------------------
set xtics ("128" 0,"256" 1,"512" 2,"1024" 3) out nomirror \
...
# labels
#-------------------------------------------------------------------------------
set label 1 "file size [B]" \
    at screen (xoff+xsiz*xnum/2), screen 0.07 center
...
i=1  ; arYhi[i]=  0.25; arYtic[i]=0.05;  arCores[i]=1; 
i=i+1; arYhi[i]= 1.35; arYtic[i]=0.2;  arCores[i]=8; 
