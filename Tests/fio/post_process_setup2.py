...
class Exp:
    ...
    def title(cls):
        # test cpy_cyc crc_cyc op_cyc iops nocpy_iops nocrc_iops no_iops
        return ('test', 'cpy_cyc', 'crc_cyc', 'opcyc', 'opcyc_nocpy', 'opcyc_nocrc', 'opcyc_no', 'iops', 'nocpy_iops', 'nocrc_iops', 'no_iops', 'iodepth')
    ...
    def __init__(self, lines, i):
        ...
        self.copy_cycles = norm_cyc(get_trace_value(lines, test, 3, trace = '1'))
