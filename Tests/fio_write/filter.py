...
if __name__ == '__main__':
    ...
    if len(argv) < 2:
        ...
        exit(1)
    if len(argv) < 3:
        keys = 'tx_crc_cycles_0 perf_cycles wr_runtime blocksize zerocopy wr_bw wr_iops iodepth Total_rx_bytes Total_rx_packets Total_tx_packets crc_cycles_0 '.split()
    else:
